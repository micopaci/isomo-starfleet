...
const styles = StyleSheet.create({
  ...
  addBtn:       { borderRadius: 8, paddingVertical: 10, alignItems: 'center', marginBottom: 12 },
  addBtnText:   { color: '#fff', fontWeight: '600', fontSize: 14 },
  saveBtn:      { borderRadius: 8, paddingVertical: 10, alignItems: 'center', marginTop: 4 },
  formCard:     { borderRadius: 10, borderWidth: 1, padding: 14, marginBottom: 14 },
  formInput:    { borderWidth: 1, borderRadius: 6, padding: 8, fontSize: 14 },
  entryCard:    { borderRadius: 10, borderWidth: 1, padding: 12, marginBottom: 10 },
