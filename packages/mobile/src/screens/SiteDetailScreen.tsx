...
const styles = StyleSheet.create({
  ...
  heroCard:      { borderRadius: 0, borderWidth: 1, padding: 16, marginBottom: 12 },
  heroTop:       { flexDirection: 'row', alignItems: 'flex-start' },
  cause:         { fontSize: 13, marginBottom: 2 },
  avgLabel:      { fontSize: 11 },
  badge:         { borderWidth: 1, borderRadius: 0, paddingHorizontal: 8, paddingVertical: 2 },
  badgeText:     { fontSize: 11 },
  tilesRow:      { flexDirection: 'row', marginBottom: 12, gap: 6 },
  card:          { borderRadius: 0, borderWidth: 1, padding: 14, marginBottom: 12 },
  ...
  statusDot:     { width: 7, height: 7, borderRadius: 0, flexShrink: 0 },
  ...
  navRow:        { flexDirection: 'row', alignItems: 'center', borderRadius: 0, borderWidth: 1,
